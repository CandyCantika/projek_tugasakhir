...
$kendaraan = isset($_GET['nama']) ? $_GET['nama'] : '';
        ...
        <div class="container-fluid">
                ...
                <div class="col-lg-12">
                    <div class="page-titles">
                        <div class="d-flex align-items-center">
                            <h2 class="heading">Form Sewa Mobil</h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="books_kendaraan.php" method="post">
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label for="tgl_mulai" class="form-label">Tanggal Penjemputan</label>
                                        <input type="date" class="form-control" id="tgl_mulai" name="tgl_mulai" required onchange="updateTglKeluar();">
                                    </div>

                                    <div class="col-md-6 mb-3">
                                        <label for="tgl_keluar" class="form-label">Tanggal Drop-off</label>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="kendaraan" name="kendaraan" value="<?= htmlspecialchars($kendaraan); ?>" required readonly>
                                </div>
